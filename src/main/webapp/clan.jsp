...
<section class="hero-section">
  ...
  <img src="https://www.cdmi.in/courses@2x/c-programming-training-institute.jpg" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">C - Language</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="c.html" class="btn btn-primary">View Course syllabus</a>
  </div>
</div> 
    </div><style>
    .dur{
...
<button type="button" class="btn btn-secondary btn-lg">45 Hours</button><br>
<div class="fee">
<button type="button" class="btn btn-primary btn-lg">Course Fee</button>
<button type="button" class="btn btn-secondary btn-lg">2500 /-</button>
</div>
...
<div class="form-group">
  ...
  <div class="form-group">
   ...
   <input type="text" disabled value="C-Language" id="phone" class="form-control"  name="ct4" aria-describedby="emailHelp"  required>C-language<br>
