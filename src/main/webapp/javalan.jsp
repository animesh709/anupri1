...
<section class="hero-section">
  ...
  <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8Ox00kU3aWUdyOaFgXEGAd5vJ6_i5Ta6-SA&usqp=CAU" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title">Java</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="javasyllabus.html" class="btn btn-primary">View Course Syllabus</a>
  </div>
</div> 
    </div><style>
    .dur{
...
<button type="button" class="btn btn-secondary btn-lg">100 hours</button><br>
<div class="fee">
<button type="button" class="btn btn-primary btn-lg">Course Fee</button>
<button type="button" class="btn btn-secondary btn-lg">10000 /-</button>
</div>
...
<div class="form-group">
  ...
  <div class="form-group">
   ...
   <input type="text" disabled value="JAVA-Language" id="phone" class="form-control"  name="ct4" aria-describedby="emailHelp"  required>C-language<br>
